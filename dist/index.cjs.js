...
var Icon$O = function (props) {
    return (React__default["default"].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default["default"].createElement("image", { width: 90, height: 90, href: "/images/egg/ticketround.png" })));
};
...
//   transform: translate3d(0, 0, 0);
// `;
var PulseLogoIcon = styled__default["default"](Icon$P)(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), pulse$1);
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default["default"].createElement(React__default["default"].Fragment, null, removeNav ?
...
var AccountModal = function (_a) {
    ...
    return (React__default["default"].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React__default["default"].createElement(Flex, { mb: "32px" },
            React__default["default"].createElement(LinkExternal, { small: true, href: "https://explorer2.etherone.one/address/" + account, mr: "16px" }, "View on EtherOne"),
...
var Menu = function (_a) {
    ...
    return (React__default["default"].createElement(Wrapper, null,
        React__default["default"].createElement(StyledNav, { showMenu: showMenu },
            React__default["default"].createElement(Logo, { removeNav: removeNav, isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
            React__default["default"].createElement(Flex, null,
                React__default["default"].createElement(UserBlock, { account: account, login: login, logout: logout }),
                profile && React__default["default"].createElement(Avatar, { profile: profile }))),
        React__default["default"].createElement(BodyWrapper, null,
            !removeNav &&
                React__default["default"].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, cakePriceLink: cakePriceLink, pushNav: setIsPushed, links: links, socials: socials }),
            React__default["default"].createElement(Inner, { isPushed: isPushed, removeNav: removeNav, showMenu: showMenu }, children),
            !removeNav && React__default["default"].createElement(MobileOnlyOverlay, { show: isPushed, onClick: function () { return setIsPushed(false); }, role: "presentation" }))));
};
